...
var LoginC = function (_Component) {
	_inherits(LoginC, _Component);

	function LoginC() {
		_classCallCheck(this, LoginC);

		var _this = _possibleConstructorReturn(this, (LoginC.__proto__ || Object.getPrototypeOf(LoginC)).call(this));
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', ref: 'op', id: 'correo', onChange: this.updateco.bind(this), className: 'form-control', placeholder: ' Correo' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'label',
						{ htmlFor: 'pwd' },
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'password', ref: 'op', id: 'pwd', onChange: this.updatepass.bind(this), className: 'form-control', placeholder: ' Contrase\xF1a' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'center',
						null,
						_react2.default.createElement('input', { type: 'button', 'data-y': 'dasas', onClick: this.logear.bind(this), className: 'btn btn-info', value: 'Enviar' }),
						_react2.default.createElement('br', null),
						_react2.default.createElement(
							'span',
							{ className: 'op' },
